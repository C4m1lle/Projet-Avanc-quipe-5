/**
 * @file tspReader.c
 * @brief Lecture des fichiers TSPLIB et gestion des problèmes TSP.
 */
...
/* Définition des constantes : sommes ASCII des mots-clés TSPLIB */
#define NAME 289 
#define COMMENT 531
#define TYPE 322
...
/**
 * @struct s_probleme
 * @brief Structure interne représentant un problème TSP.
 */
struct s_probleme {
    char * name;               /**< Nom de l'instance */
    char * comment;            /**< Commentaire */
    char * type;               /**< Type du problème */
    int dimension;             /**< Nombre de villes */
    char * edge_weight_type;   /**< Type de distance (EUC_2D, ATT, GEO) */
    char * display_data_type;  /**< Type d'affichage */
    tTournee tournee;          /**< Tournée correspondant aux villes */
};

/**
 * @brief Crée une structure tProbleme vide.
 * @return tProbleme Nouveau problème initialisé
 */
...
/**
 * @brief Alloue une copie d'une chaîne de caractères.
 * @param buffer Chaîne source
 * @return char* Chaîne dupliquée
 */
...
tProbleme load_problem(const char * filepath){
    ...
    do{
        ...
        /* Calcul de la somme ASCII du mot-clé */
        i = 0;
        sum = 0;
